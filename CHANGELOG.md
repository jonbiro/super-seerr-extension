...
- Add a popup race regression covering refresh completion during clear and the final empty state.
...
- Add display regressions for a changed release year and an unknown year.
