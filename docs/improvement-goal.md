...
| Actionable Seerr/permissions/API-key/Plex popup diagnostics | Pending | Pending |
| Worker-mediated content cache access and trusted secret storage | Pending | Pending |
| Seven-site browser coverage, Firefox, upgrade coverage, production-behavior tests | In progress | Four Chromium tests pass; Firefox 147.0.3 real-extension permissions/injection/SPA/reload/cache/revocation test passes; seven-site live and upgrade checks pending |
...
| Local recent actions without secrets | Pending | Pending |
