...
| Seven-site browser coverage, Firefox, upgrade coverage, production-behavior tests | In progress | Chromium and Firefox cover eleven synthetic movie/TV pages across all seven supported origins using real manifest injection. Actual 3.5.2 upgrades preserve settings and migrate legacy secrets in both browsers. Live-site checks and final production-test audit remain pending |
