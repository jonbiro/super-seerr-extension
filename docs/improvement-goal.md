...
| Seven-site browser coverage, Firefox, upgrade coverage, production-behavior tests | In progress | Eight Chromium tests pass; Firefox 147.0.3 real-extension permissions/injection/SPA/reload/cache/revocation test passes; seven-site live and upgrade checks pending |
