...
- [ ] Pause notification dismissal on hover and keyboard focus; retain actionable errors longer.
- [ ] Establish live regions before content updates; verify announcements with VoiceOver where available.
...
- [ ] Add saved-match search, server labels and individual details.
